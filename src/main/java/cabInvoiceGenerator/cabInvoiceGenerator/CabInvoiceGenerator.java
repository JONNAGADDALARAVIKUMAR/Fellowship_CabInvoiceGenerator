...
public class CabInvoiceGenerator {
	...
	public InvoiceSummary totalFare(Ride[] rides) { // Calculates Total Fare From Multiple rides
		double totalFare = 0; 
		for (Ride ride : rides) {
	...
	public InvoiceSummary calculateTotalFareFromRepository(int id) { //Calculates Total Fare from Repository Data
